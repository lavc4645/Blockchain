...
contract SharedTokenWallet{
    ...
    event Player1Ready();
    event Player2Ready();
    event TokenPurchased(uint _balance);
    ...
    function purchaseToken() public payable onlyApproved()  {
        ...
        if(msg.sender == player1){
            ...
            emit TokenPurchased(tokenBalance[player1]);
